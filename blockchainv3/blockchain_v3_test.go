...
import (
	...
	"github.ibm.com/ibmcloud/blockchain-go-sdk/blockchainv3"
	"io"
	"io/ioutil"
	"net/http"
	"net/http/httptest"
...
var _ = Describe(`BlockchainV3`, func() {
	...
	Describe(`Service constructor tests using external config`, func() {
		Context(`Using external config, construct service client instances`, func() {
			...
			It(`Create service client using external config successfully`, func() {
				...
				testService, testServiceErr := blockchainv3.NewBlockchainV3UsingExternalConfig(&blockchainv3.BlockchainV3Options{
				})
				Expect(testService).ToNot(BeNil())
				Expect(testServiceErr).To(BeNil())
	...
	Describe(`CaAction(caActionOptions *CaActionOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CaAction with error: Operation response processing error`, func() {
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := testService.CaAction(caActionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`CaAction(caActionOptions *CaActionOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke CaAction successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := testService.CaAction(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke CaAction with error: Operation validation and request error`, func() {
				...
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = testService.CaAction(caActionOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`PeerAction(peerActionOptions *PeerActionOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke PeerAction with error: Operation response processing error`, func() {
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := testService.PeerAction(peerActionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`PeerAction(peerActionOptions *PeerActionOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke PeerAction successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := testService.PeerAction(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke PeerAction with error: Operation validation and request error`, func() {
				...
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = testService.PeerAction(peerActionOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`OrdererAction(ordererActionOptions *OrdererActionOptions) - Operation response error`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke OrdererAction with error: Operation response processing error`, func() {
				...
				// Expect response parsing to fail since we are receiving a text/plain response
				result, response, operationErr := testService.OrdererAction(ordererActionOptionsModel)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).ToNot(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`OrdererAction(ordererActionOptions *OrdererActionOptions)`, func() {
		...
		Context(`Using mock server endpoint`, func() {
			...
			It(`Invoke OrdererAction successfully`, func() {
				...
				// Invoke operation with nil options model (negative test)
				result, response, operationErr := testService.OrdererAction(nil)
				Expect(operationErr).NotTo(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			...
			It(`Invoke OrdererAction with error: Operation validation and request error`, func() {
				...
				// Invoke operation with invalid model (negative test)
				result, response, operationErr = testService.OrdererAction(ordererActionOptionsModelNew)
				Expect(operationErr).ToNot(BeNil())
				Expect(response).To(BeNil())
				Expect(result).To(BeNil())
			})
	...
	Describe(`Model constructor tests`, func() {
		Context(`Using a service client instance`, func() {
			testService, _ := blockchainv3.NewBlockchainV3(&blockchainv3.BlockchainV3Options{
			...
			It(`Invoke NewCaActionOptions successfully`, func() {
				...
				// Construct an instance of the CaActionOptions model
				id := "testString"
				caActionOptionsModel := testService.NewCaActionOptions(id)
			...
			It(`Invoke NewCreateOrdererOptions successfully`, func() {
				...
				createOrdererOptionsModel := testService.NewCreateOrdererOptions(createOrdererOptionsOrdererType, createOrdererOptionsMspID, createOrdererOptionsDisplayName, createOrdererOptionsCrypto)
			...
			It(`Invoke NewCreatePeerOptions successfully`, func() {
				...
				createPeerOptionsModel := testService.NewCreatePeerOptions(createPeerOptionsMspID, createPeerOptionsDisplayName, createPeerOptionsCrypto)
			...
			It(`Invoke NewCryptoObjectEnrollmentCa successfully`, func() {
				...
				model, err := testService.NewCryptoObjectEnrollmentCa(host, port, name, tlsCert, enrollID, enrollSecret)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewCryptoObjectEnrollmentTlsca successfully`, func() {
				...
				enrollID := "admin"
				enrollSecret := "password"
				model, err := testService.NewCryptoObjectEnrollmentTlsca(host, port, name, tlsCert, enrollID, enrollSecret)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewCryptoObjectMsp successfully`, func() {
				...
				_, err := testService.NewCryptoObjectMsp(component, ca, tlsca)
				Expect(err).ToNot(BeNil())
			})
			...
			It(`Invoke NewImportCaBodyMsp successfully`, func() {
				...
				_, err := testService.NewImportCaBodyMsp(ca, tlsca, component)
				Expect(err).ToNot(BeNil())
			})
			It(`Invoke NewImportCaBodyMspCa successfully`, func() {
				name := "org1CA"
				model, err := testService.NewImportCaBodyMspCa(name)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewImportCaBodyMspComponent successfully`, func() {
				tlsCert := "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo="
				model, err := testService.NewImportCaBodyMspComponent(tlsCert)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewImportCaBodyMspTlsca successfully`, func() {
				name := "org1tlsCA"
				model, err := testService.NewImportCaBodyMspTlsca(name)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewImportCaOptions successfully`, func() {
				...
				importCaOptionsModel := testService.NewImportCaOptions(importCaOptionsDisplayName, importCaOptionsApiURL, importCaOptionsMsp)
			...
			It(`Invoke NewImportOrdererOptions successfully`, func() {
				...
				importOrdererOptionsModel := testService.NewImportOrdererOptions(importOrdererOptionsClusterName, importOrdererOptionsDisplayName, importOrdererOptionsGrpcwpURL, importOrdererOptionsMsp, importOrdererOptionsMspID)
			...
			It(`Invoke NewImportPeerOptions successfully`, func() {
				...
				importPeerOptionsModel := testService.NewImportPeerOptions(importPeerOptionsDisplayName, importPeerOptionsGrpcwpURL, importPeerOptionsMsp, importPeerOptionsMspID)
			...
			It(`Invoke NewMspCryptoCa successfully`, func() {
				...
				model, err := testService.NewMspCryptoCa(rootCerts)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewMspCryptoComp successfully`, func() {
				...
				tlsKey := "testString"
				tlsCert := "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo="
				model, err := testService.NewMspCryptoComp(ekey, ecert, tlsKey, tlsCert)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewMspCryptoFieldComponent successfully`, func() {
				tlsCert := "LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo="
				model, err := testService.NewMspCryptoFieldComponent(tlsCert)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewMspCryptoFieldTlsca successfully`, func() {
				rootCerts := []string{"LS0tLS1CRUdJTiBDRVJUSUZJQ0FURS0tLS0tCkNlcnQgZGF0YSB3b3VsZCBiZSBoZXJlIGlmIHRoaXMgd2FzIHJlYWwKLS0tLS1FTkQgQ0VSVElGSUNBVEUtLS0tLQo="}
				model, err := testService.NewMspCryptoFieldTlsca(rootCerts)
				Expect(model).ToNot(BeNil())
				Expect(err).To(BeNil())
			})
			It(`Invoke NewOrdererActionOptions successfully`, func() {
				...
				// Construct an instance of the OrdererActionOptions model
				id := "testString"
				ordererActionOptionsModel := testService.NewOrdererActionOptions(id)
			...
			It(`Invoke NewPeerActionOptions successfully`, func() {
				...
				// Construct an instance of the PeerActionOptions model
				id := "testString"
				peerActionOptionsModel := testService.NewPeerActionOptions(id)
			...
			It(`Invoke NewMspCryptoField successfully`, func() {
				...
				_, err := testService.NewMspCryptoField(tlsca, component)
				Expect(err).ToNot(BeNil())
			})
		})
	})
